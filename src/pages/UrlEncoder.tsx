...
export default function UrlEncoder() {
  useDocumentMeta('URL Encoder & Decoder Free Online | MergeDoc', 'Encode or decode URL components instantly, entirely in your browser.')
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-16">
      ...
      <p className="mt-2 text-slate-500 dark:text-slate-400">Encode text for use in a URL, or decode it back.</p>
